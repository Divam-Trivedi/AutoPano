...
def main():
    ...
    images_folder_path = "/Users/tvidk/Library/CloudStorage/OneDrive-WorcesterPolytechnicInstitute(wpi.edu)/WPI/Education/RBE 549/Project 1/Divam/YourDirectoryID_p1/Phase1/Data/Test/TestSet4"
    output_folder_path = "/Users/tvidk/Library/CloudStorage/OneDrive-WorcesterPolytechnicInstitute(wpi.edu)/WPI/Education/RBE 549/Project 1/Divam/YourDirectoryID_p1/Phase1/Data/Test/OutputTestSet4"
    ...
    print("\nReading images...")
    images = []
    image_files = sorted([f for f in os.listdir(images_folder_path) if f.endswith('.jpg') or f.endswith('.png') or f.endswith('.jpeg')])
    for f in image_files:
        print(f"Reading {f}")
        img = cv2.imread(os.path.join(images_folder_path, f))
    ...
    # cv2.imwrite(f'{output_folder_path}/corners.png', corner_vis)
    ...
    # cv2.imwrite(f'{output_folder_path}/anms.png', anms_vis)
    ...
    # cv2.imwrite(f'{output_folder_path}/FD.png', fd_vis)
    # print("Saved FD.png")
    ...
    for i in range(1, len(images)):
        ...
        if len(matches) > 0:
            ...
            cv2.imwrite(f'{output_folder_path}/matching_{i}.png', match_vis)
            ...
            if H is not None:
                ...
                try:
                    ...
                    cv2.imwrite(f'{output_folder_path}/panorama_{i}.png', panorama)
    ...
    # Save final panorama
    cv2.imwrite(f'{output_folder_path}/mypano.png', panorama)
